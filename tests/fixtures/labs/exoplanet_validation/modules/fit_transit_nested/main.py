"""fit_transit_nested, exoplanet_validation: transform; dynesty nested-sampling fit, the reference method."""
...
@dae.entry
def fit_transit_nested(ctx: dae.FlowContext) -> None:
    ...
    # Uniform priors over physical ranges centered on the carried truths.
