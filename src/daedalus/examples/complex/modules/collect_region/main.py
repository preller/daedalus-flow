"""complex / collect_region: pass-through walk collector."""
...
@dae.entry
def collect_region(ctx: dae.FlowContext) -> None:
    # Three collectors in sequence each sleep 1 s; the lab takes about 3 s.
    time.sleep(1)
